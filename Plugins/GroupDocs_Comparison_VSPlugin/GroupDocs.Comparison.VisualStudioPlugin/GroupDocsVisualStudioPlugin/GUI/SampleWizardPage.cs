...
using System.Xml;
using GroupDocsComparisonVisualStudioPlugin.XML;
...
namespace GroupDocsComparisonVisualStudioPlugin.GUI
{
    public partial class SampleWizardPage : Form
    {
        ...
        public SampleWizardPage(DTE2 application)
        {
            ...
            PopulateTreeView(repoPath + "/Examples/" + (rdbCSharp.Checked ? "GroupDocs.Comparison.Examples.CSharp" : "GroupDocs.Comparison.Examples.VisualBasic"));
        ...
        bool CopyAndCreateProject()
        {
            ...
            //string sampleSourcePath = "GroupDocs.Comparison";
