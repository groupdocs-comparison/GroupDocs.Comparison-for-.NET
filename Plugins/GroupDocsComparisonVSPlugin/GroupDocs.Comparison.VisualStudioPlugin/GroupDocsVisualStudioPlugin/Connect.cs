...
namespace GroupDocsComparisonVisualStudioPlugin
{
    public class Connect : Extensibility.IDTExtensibility2, IDTCommandTarget
    {
        ...
        private const string WORDS_COMMAND_CAPTION = "New GroupDocs.Comparison Example Project";
        private const string WORDS_COMMAND_TOOLTIP = "Download and Run GroupDocs.Comparison for .NET API Examples";
