...
namespace GroupDocs.Comparison.Live.Demos.UI
{
	public static class AppSettings
	{
		...
		{
			get { return _outputDirectory.Replace('\\', '/'); }
		}

		public static string WorkingDirectory
		{
			get { return _workingDirectory.Replace('\\', '/'); }
		}

		public static string StorageDirectory
		{
			get { return _storageDirectory.Replace('\\', '/'); }
		}

		public static string FilesBaseDirectory
		{
			get { return _filesBaseDirectory.ToLower().Replace('\\', '/'); }
		}
	}
}